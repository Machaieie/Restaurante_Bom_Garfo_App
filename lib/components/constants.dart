...
const Color primaryColor = Color(0xFFF8AC00); // Color(0xFF7B61FF);
...
final phoneNumberValidator = MultiValidator([
  ...
  PatternValidator(r'^8(2|3|4|5|6|7)[0-9]{7}',
      errorText: "Phone Number must be Mozambique prefix"),
]);
...
Size mediaQuerySize(BuildContext context) => MediaQuery.of(context).size;
